...
def main(args):
    ...
    try:
        ...
        logger.info(
            f"Data loaded successfully - Shapes: X_train={X_train.shape}, y_train={y_train.shape}"
        )
    ...
    # Select best model
    best_model_type, best_model_path = select_best_model(comparison_df, metric=args.metric)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--quick-test", action="store_true", help="Run a quick test with fewer models"
    )
